<!DOCTYPE html>
			...
			<html lang="es-AR">
			  ...
			  <head>
    			...
    			<link rel="canonical" href="http://huellascotillon.com/promo364305122017.php"/>
			    ...
			    <meta property="og:url" content="http://www.huellascotillon.com/promo364305122017.php" />
			    <meta property="og:type" content="website" />
			    <meta property="og:title" content="Huellas Cotill&oacute;n & Candy Bar" />
			    <meta property="og:image" content="http://huellascotillon.com/img/upload/promo51603057.jpg" />
			    <meta property="og:description" content="Promoción 1: Candy Bar" />			    
			  </head>
			...
			?>
			    ...
			    <section class="container">
	              ...
	              <div class="col-12 text-center">
	                <div class="mt-2">
	                  <img class="CsimagenGrande" src="img/upload/promo51603057.jpg" alt="Promocion15">
	                </div>
	              </div>
			        </div>
			        <!--==============DESCRIPCION=============-->
			        <div class="offset-1 col-10">
			          <div class="col-12">
				        <h4 class="CsSeccionTitulo animated tada">Promoción 1: Candy Bar</h4>
			            <p>caramelo x50
Alfajor Chocolate x25</p>
			            <p class="text-muted mt-1">12 de mayo de 2017</p>
			            <p class="h2 text-danger mt-3 text-center">Precio $123.00</p>
			          </div>
			          <div class="col-12 text-right">
			            <div class="fb-like" data-href="http://sersytems.com/huellas/promo364305122017.php" data-width="250" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
			          </div>
			        </div>
			        <!--===============SEPARADOR==============-->
			        <div class="offset-1 col-10">
			        ...
			        <div class="offset-md-1 col-md-10">
			          <div class="fb-comments" data-href="http://sersytems.com/huellas/promo364305122017.php" data-mobile="true" data-numposts="5" data-order-by="reverse_time"></div>
			        </div>
			      </div>
			    </section>

<!DOCTYPE html>
			...
			<html lang="es-AR">
			  ...
			  <head>
    			...
    			<link rel="canonical" href="http://huellascotillon.com/promo756205122017.php"/>
			    ...
			    <meta property="og:url" content="http://www.huellascotillon.com/promo756205122017.php" />
			    ...
			    <meta property="og:description" content="Promoción Disfraces" />			    
			  </head>
			...
			?>
			    ...
			    <section class="container">
	              ...
	              <div class="col-12 text-center">
	                <div class="mt-2">
	                  <img class="CsimagenGrande" src="" alt="Promocion18">
	                </div>
	              </div>
			        </div>
			        <!--==============DESCRIPCION=============-->
			        <div class="offset-1 col-10">
			          <div class="col-12">
				        <h4 class="CsSeccionTitulo animated tada">Promoción Disfraces</h4>
			            <p class="text-justify">disfraz de princesa</p>
			            <p class="text-muted mt-1">05 de diciembre de 2017</p>
			            <p class="h2 text-danger mt-3 text-center">Precio $39.00</p>
			          </div>
			          <div class="col-12 text-right">
			            <div class="fb-like" data-href="http://sersytems.com/huellas/promo756205122017.php" data-width="250" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
			          </div>
			        </div>
			        <!--===============SEPARADOR==============-->
			        <div class="offset-1 col-10">
			        ...
			        <div class="offset-md-1 col-md-10">
			          <div class="fb-comments" data-href="http://sersytems.com/huellas/promo756205122017.php" data-mobile="true" data-numposts="5" data-order-by="reverse_time"></div>
			        </div>
			      </div>
			    </section>

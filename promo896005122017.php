<!DOCTYPE html>
			...
			<html lang="es-AR">
			  ...
			  <head>
    			...
    			<link rel="canonical" href="http://huellascotillon.com/promo896005122017.php"/>
			    ...
			    <meta property="og:url" content="http://www.huellascotillon.com/promo896005122017.php" />
			    ...
			    <meta property="og:description" content="Promoción Cotillón Para Cumpleaños" />			    
			  </head>
			...
			?>
			    ...
			    <section class="container">
	              ...
	              <div class="col-12 text-center">
	                <div class="mt-2">
	                  <img class="CsimagenGrande" src="" alt="Promocion17">
	                </div>
	              </div>
			        </div>
			        <!--==============DESCRIPCION=============-->
			        <div class="offset-1 col-10">
			          <div class="col-12">
				        <h4 class="CsSeccionTitulo animated tada">Promoción Cotillón Para Cumpleaños</h4>
			            <p class="text-justify">pi?ata grande
globo x 50
papelito picado x3</p>
			            <p class="text-muted mt-1">08 de agosto de 2017</p>
			            <p class="h2 text-danger mt-3 text-center">Precio $444.00</p>
			          </div>
			          <div class="col-12 text-right">
			            <div class="fb-like" data-href="http://sersytems.com/huellas/promo896005122017.php" data-width="250" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
			          </div>
			        </div>
			        <!--===============SEPARADOR==============-->
			        <div class="offset-1 col-10">
			        ...
			        <div class="offset-md-1 col-md-10">
			          <div class="fb-comments" data-href="http://sersytems.com/huellas/promo896005122017.php" data-mobile="true" data-numposts="5" data-order-by="reverse_time"></div>
			        </div>
			      </div>
			    </section>
